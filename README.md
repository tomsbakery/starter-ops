...
In the first case, the application should commit a `README.md` to the repository, thereby creating a default branch, issue the branch protections in the repository branch settings, and then file an issue notifying the organization admin of actions taken with a summary of the branch protections.
